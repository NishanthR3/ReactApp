...
class UpdateQuestions extends Component {
  constructor() {
    ...
    this.handleActualName = this.handleActualName.bind(this);
  ...
  async handleSubmit(event){
    ...
    await fetch('http://localhost:8080/question/' + this.state.actualname, {
     method: 'PUT',
  ...
  handleActualName(event) {
    this.state.actualname = event.target.value;
  }
  handleName(event) {
    ...
    return (
            <div>
                    ...
                    <div className="formContainer">
                          ...
                          <tr>
                          <td></td>
                          <td><label><h2>Actual Question</h2></label></td>
                          <td><textarea value={this.state.name} onChange={this.handleActualName}/></td>
                          </tr>
                          <tr>
                          <td></td>
                          <td><label><h2>Updated Question</h2></label></td>
